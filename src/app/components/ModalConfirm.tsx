...
export function ModalConfirm() {
	...
	return (
		...
		>
			...
			>
				<p className='text-[var(--tertiary-color)] text-lg mb-6 text-center'>
					{MESSAGES_MAP[modal.type]}
				</p>
				<div className='flex gap-3 justify-center'>
					<button
						onClick={closeModal}
						className='flex-1 px-6 py-2 rounded-full bg-[var(--secondary-color)] text-white hover:opacity-80 transition-all duration-100'
					>
						Cancel
					</button>
					<button
